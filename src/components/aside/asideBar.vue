<template>
    <div class="h-full">
        ...
        <aside id="logo-sidebar" class="  
           h-full shadow-md border-r border-gray-200 
           flex flex-col" aria-label="Sidebar">
            <!-- Logo et sélection du pays -->
            <section class="p-5 ">
                <div class="flex items-center mb-4">
                    <img :src="mini_app_icons" alt="Logo" class="mr-2 flex-shrink-0" />
            ...
            <!-- Footer utilisateur -->
            <section @click.prevent="handleLogout"
                ...
                <div class="flex items-center justify-between">
                    <section class="flex gap-1 flex-1 min-w-0">
                        <img src="/src/assets/images/avatar/avatar108.png" alt="User"
                            class="w-10 h-10 rounded-full mr-2 flex-shrink-0" />
                        <div class="overflow-hidden transition-all duration-300  ease-in-out min-w-0"
                            :class="isSidebarExpanded ? 'max-w-xs opacity-100 delay-500' : 'max-w-0 opacity-0'">
                            <div class="whitespace-nowrap">
                                <p class="text-sm text-black font-medium truncate">{{ fullName() }}</p>
                                <p class="text-xs text-neutral-30 group-hover:text-red-500 truncate">{{ user?.email }}
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="flex-shrink-0 transition-all duration-300  ease-in-out"
                        :class="isSidebarExpanded ? 'max-w-xs opacity-100 delay-500' : 'max-w-0 opacity-0'">
                        <svg class="w-[17px] h-[17px] text-neutral-20 transition duration-300 group-hover:text-red-500"
