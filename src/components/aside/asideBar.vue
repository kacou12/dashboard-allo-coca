<template>
    <aside id="logo-sidebar" :class="` top-0 left-0 z-40 h-screen transition-transform -translate-x-full 
                ...
                <section class="flex gap-1 flex-1 min-w-0">
                    ...
                    <div class="overflow-hidden transition-all duration-300  ease-in-out min-w-0"
                        ...
                        <div class="whitespace-nowrap">
                            ...
                            <p class="text-xs text-neutral-30 group-hover:text-red-500 truncate">{{ user?.email }}</p>
                        </div>
                    </div>
                </section>
