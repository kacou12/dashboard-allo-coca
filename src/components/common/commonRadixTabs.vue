<template>
    <TabsRoot class="flex flex-col w-full sm:w-[300px] shadow-[0_2px_10px] shadow-blackA4" default-value="tab1">
        <TabsList class="relative  border-b border-mauve6 flex " aria-label="Manage your account">
            <TabsIndicator
        ...
        <TabsContent class="grow p-5 bg-white rounded-b-md outline-none focus:shadow-[0_0_0_2px] focus:shadow-black"
            ...
            <fieldset class="mb-[15px] w-full flex flex-col justify-start">
                <label class="text-[13px] leading-none mb-2.5 text-green12 block" for="newPassword"> New password
                </label>
