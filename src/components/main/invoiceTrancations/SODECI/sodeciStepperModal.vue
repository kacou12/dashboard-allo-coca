<template>
    <CommonModal text-defaul-size="" :isPersisted="true" v-model:open="open" backgroudColor="bg-white"
        ...
        <template #title>
            <h2>Paiement de facture SODECI</h2>
        </template>
...
import CieInitPaymentStepThree from '@/components/main/invoiceTrancations/CIE/cieInitPaymentStepThree.vue';
import CieSelectInvoiceStepTwo from '@/components/main/invoiceTrancations/CIE/cieSelectInvoiceStepTwo.vue';
import CieSetIdentifierStepOne from '@/components/main/invoiceTrancations/CIE/cieSetIdentifierStepOne.vue';
