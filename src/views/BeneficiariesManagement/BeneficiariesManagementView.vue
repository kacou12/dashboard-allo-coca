    ...
    <div class="px-4 bg-white">
        ...
        <header class="flex justify-between items-center">
            <div class="mb-6 space-y-1">
                ...
                <h1 class="text-xl font-bold font-merriweathersans leading-6 text-black">Gestion des bénéficiaires</h1>
                <p class="text-neutral-30 text-sm font-normal">Gérer et créer des bénéficiaires</p>
            </div>
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:my-4">
            <section class="flex gap-2 items-center">
                <p class="text-[18px] font-semibold">Vos béneficiaires</p>
                <div>
                    <span
                        class="text-xs font-medium px-[5px] py-[1px]  rounded-xl border text-[#633DA5] border-[#633DA5]"><span
                            v-if="isFetched">{{ beneficiariesData!.total }}</span>
                        bénéficiaire(s)</span>
                </div>
            </section>
        ...
        <div class=" w-full ">
            ...
            <CommonDataTable :page-size="limitModel ? parseInt(limitModel) : 10" ref="my-table"
                :default-page="filters.page" :total="beneficiariesData?.total ?? 0" :columns="beneficiariesColumns"
                :data="beneficiariesData?.items ?? []" @go-to-page="goToPage" @prev-page="prevPage"
                @next-page="nextPage">
            </CommonDataTable>
        </div>
